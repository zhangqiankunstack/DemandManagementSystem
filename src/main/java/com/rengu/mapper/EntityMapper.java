...
//            "FROM relationship INNER JOIN entity ON relationship.entity_id2 = entity.entity_id OR relationship.entity_id1 = entity.entity_id " +
//            "WHERE entity.entity_id = #{entityId} AND (#{keyWord}::text IS NULL OR entity.entity_type LIKE CONCAT('%', #{keyWord}::text, '%'))")

//    @Select("SELECT DISTINCT relationship.relationship_id,relationship.entity_id1,entity.entity_name as entity_name1 ,relationship.entity_id2,entity.entity_name as entity_name2,relationship.relationship_type as relationship_type,entity.entity_type AS entity_type " +
//            "FROM relationship INNER JOIN entity ON relationship.entity_id2 = entity.entity_id OR relationship.entity_id1 = entity.entity_id " +
//            "WHERE entity.entity_id != #{entityId} AND (relationship.entity_id1 = #{entityId} OR relationship.entity_id2 = #{entityId}) AND (#{keyWord}::text IS NULL OR entity.entity_type LIKE CONCAT('%', #{keyWord}::text, '%'))")

    @Select("SELECT    relationship.relationship_id,relationship.entity_id1,entity.entity_name as entity_name1 ,relationship.entity_id2,entity.entity_name as entity_name2,relationship.relationship_type as relationship_type,entity.entity_type AS entity_type " +
            "FROM relationship INNER JOIN entity ON relationship.entity_id2 = entity.entity_id OR relationship.entity_id1 = entity.entity_id " +
            "WHERE entity.entity_id != #{entityId} AND (relationship.entity_id1 = #{entityId} OR relationship.entity_id2 = #{entityId})")
    //AND (#{keyWord}::text IS NULL OR entity.entity_type LIKE CONCAT('%', #{keyWord}::text, '%'))
